  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Nueva Facultad <span id="load" style="display:none"> <img src="img/loading.gif"> Cargando...</span></h4>
      </div>
      <div class="modal-body">
        <form id="formFacultad" method="post" action="procesarFacultades.php">
          <div class="form-group">
            <label for="id_facultad">Código Facultad</label>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="facu_descripcion" name="facu_descripcion" placeholder="Facultad" required value="" style="text-transform:uppercase">
