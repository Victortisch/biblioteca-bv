...
<html lang="es">
  <head>
    ...
    while ($row = mysql_fetch_array($results)) {
        $accion = '<a href="#" class="edit" data-toggle="modal" data-target="#myModal" id='.$row['gene_codigo'].'><i class="fa fa-edit"> Editar </i></a>';
    ...
    var dataSet = <?php echo json_encode($encode);?>;
      $(document).ready(function() {
        ...
        $('#example tbody').on('click', 'tr', function () {
          ...
          $('#formGeneros input[name="modificar"]').val(1);
        } );
        ...
        $('#nuevo_gen').on('click', function() {
          ...
          $('#formGeneros input[name="modificar"]').val(0);
        });
      });
